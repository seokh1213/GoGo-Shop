...
public class CommonException extends BaseException {
    ...
    public static CommonException ACCESS_TOKEN_EXPIRED = new CommonException(403, "ACCESS_TOKEN_EXPIRED");
    public static CommonException REFRESH_TOKEN_EXPIRED = new CommonException(403, "REFRESH_TOKEN_EXPIRED");
